...
private:
	...
	void drawValvePair(const EngineMesh& cylinderMesh, ShaderProgram* shader, const glm::mat4& view, const glm::mat4& projection, float z, float lift, const glm::vec4& color) const;
	...
	void drawValveSeats(const EngineMesh& cylinderMesh, const EngineMesh& halfDiskMesh, ShaderProgram* shader, const glm::mat4& view, const glm::mat4& projection) const;
	...
	void drawSpring(const EngineMesh& cylinderMesh, ShaderProgram* shader, const glm::mat4& view, const glm::mat4& projection, const glm::vec3& bottom, const glm::vec3& top, float lift) const;
